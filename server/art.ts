...
export const ANIMAL_ART: Record<AnimalId, string[][]> = {
  // 1. INTJ raven — hooked beak <, ✦ eyes, 4 frames (look right)
  raven: [
    ["            ", "  <(✦)      ", "   (\\ \\_    ", "    \\\\//    ", '  --" "---  '],
    ["            ", "  <(✦)      ", "   (\\\\ \\_   ", "    \\\\//    ", '  --" "---  '],
    ["            ", "  <(✧)      ", "   (\\ \\_    ", "    \\\\//    ", '  --" "---  '],
  ...
  // 2. INTP owl — compact, big eyes {◉,◉}, shifts left/right/left
  owl: [
    ["            ", "            ", "    {◉,◉}   ", "    /)_)    ", '  ——" "——   '],
    ["            ", "            ", "     {◉,◉}  ", "    /)_)    ", '  ——" "——   '],
    ["            ", "            ", "    {-,-}   ", "    /)_)    ", '  ——" "——   '],
  ...
  // 3. ENTJ bear — c .-.  C head, ʘ eyes, d|b paws, 7 frames (slam/wave/mouth)
  bear: [
    ["            ", " c  .-.  C  ", "( ʘ  .  ʘ ) ", "(   ww    ) ", "  d|   |b   "],
    ["            ", " c  .-.  C  ", "( ʘ  .  ʘ ) ", "(d  ww    ) ", "   |   |b   "],
    ["            ", " c  .-.  C  ", "( -  .  - ) ", "(   ww    ) ", "  d|   |b   "],
    ["            ", " c  .-.  C  ", "( ʘ  .  ʘ ) ", "( d ww    ) ", "   |   |b   "],  // wave B
    ["            ", " c  .-.  C  ", "( ◉  .  ◉ ) ", "( d|   |b  )", " ---------- "],  // slam A
    ["            ", " c  .-.  C  ", "( ◉  .  ◉ ) ", "(   ww    ) ", "~d|~~~|b~~  "],  // slam B
    ["            ", " c  .-.  C  ", "( ʘ  .  ʘ ) ", "(   VV    ) ", "  d|   |b   "],  // mouth twitch
  ],
  // 4. ENTP fox — pointy ears, -.- default, 3 frames
  fox: [
    ["            ", "   /\\  /\\   ", "  ( -.-  )  ", "   > ^ <    ", "    /_\\~~~  "],
    ["            ", "   /\\  /\\   ", "  ( >.<  )  ", "   > ^ <    ", "    /_\\~~>  "],
    ["            ", "   /\\  /\\   ", "  ( o.o  )  ", "   > ^ <    ", "    /_\\~~~  "],
  ],
  // 5. INFJ wolf — _Λ/ᐠ ears, ✦ eyes, 8 frames (walk/howl/alert/stretch/sniff)
  wolf: [
    ["            ", "  _Λ/ᐠ      ", " (✦   |__  )", "  \\\\  /   - ", "  |  |  ||  "],
    ["            ", "  _Λ/ᐠ      ", " (✦   |__  )", "  \\\\  /   ~ ", "  |  |  ||  "],
    ["            ", "  _Λ/ᐠ      ", " (-   |__  )", "  \\\\  /   - ", "  |  |  ||  "],
  ...
  // 6. INFP deer — forked antlers }|/ \|{, 7 frames (graze/tilt/gaze/nuzzle)
  deer: [
    ["            ", "  }|/  \\|{  ", "   (\\__/)   ", "   (o  o)   ", "    (  )    "],
    ["            ", "  }|/  \\|{  ", "   (\\__/)   ", "   (o  o)   ", "    (  )~   "],
    ["            ", "  }|/  \\|{  ", "   (\\__/)   ", "   (-  o)   ", "    (  )    "],
  ...
  labrador: [
    ...
    ["            ", "      __/\\  ", "    __/@ )  ", "   O     \\  ", "    U \\___\\~"],
    ["            ", "      __/\\  ", "    __/- )  ", "   O     \\  ", "    U \\___\\-"],
    ["            ", "      __/\\  ", "    __/@ )  ", "  O>     \\  ", "    U \\___\\-"],  // nuzzle
    ["            ", "      __/\\  ", "    __/@ )  ", "   O     \\  ", "    Ö \\___\\-"],  // yawn
    ["            ", "      __/\\  ", "    __/@ )  ", "   O     \\  ", "   UU \\___\\~"],  // pant
    ["            ", "      __/\\  ", "    __/@ )  ", "   O  ______", "   U/     \\-"],  // liedown A
  ...
  // 15. ESTP cheetah — spots on legs, speed line ~, 4 actions (sprint/pounce/twitch/yawn)
  cheetah: [
    ["            ", "   /\\_/\\  ~ ", "  (o . o)   ", "   >.v.<    ", "  /|'.|\\    "],
    ["            ", "   /\\_/\\  ~ ", "  (o . o)   ", "   >.v.<    ", "  /|'.|\\~   "],
    ["            ", "   /\\_/\\  ~ ", "  (- . o)   ", "   >.v.<    ", "  /|'.|\\    "],
    ["            ", "   /\\_/\\~~~~", "  (o . o)   ", "   >.v.<    ", "  _/' .\\_   "],  // sprint A
    ["            ", " ~/\\_/\\ ~~~ ", "  (o . o)   ", "   >.v.<    ", "   \\_'. /   "],  // sprint B
    ["            ", "   /\\_/\\    ", "  (\u25c9 . \u25c9)   ", "   >.v.<    ", "  _|'._|_   "],  // pounce
    ["            ", "   __ __  ~ ", "  (o . o)   ", "   >.v.<    ", "  /|'.|\\    "],  // twitch A
    ["            ", "  /\\_ __  ~ ", "  (o . o)   ", "   >.v.<    ", "  /|'.|\\    "],  // twitch B
    ["            ", "   /\\_/\\    ", "  (- . -)   ", "   >.O.<    ", "  /|'.|\\    "],  // yawn
  ],
  // 16. ESFP parrot — hooked beak >, crest, perch |||, 4 actions (sing/flap/bob/preen)
  parrot: [
    ["            ", "    ,__     ", "  >(o  )    ", "   \\\\__/    ", "    |||     "],
    ["            ", "    ,__     ", "  >(o  )    ", "   \\\\__/    ", "    |||~    "],
    ["            ", "    ,__     ", "  >(-  )    ", "   \\\\__/    ", "    |||     "],
