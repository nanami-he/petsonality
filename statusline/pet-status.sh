...
# Bubble border color (independent of pet body color)
...
LAB_ACT="$HOME/.mbti-pet/.lab_act"; [ "$PET_ID" = "labrador" ] && [ -f "$LAB_ACT" ]; then
...
DEER_ACT="$HOME/.mbti-pet/.deer_act"; [ "$PET_ID" = "deer" ] && [ -f "$DEER_ACT" ]; then
...
WOLF_ACT="$HOME/.mbti-pet/.wolf_act"; [ "$PET_ID" = "wolf" ] && [ -f "$WOLF_ACT" ]; then
...
BEAVER_ACT="$HOME/.mbti-pet/.beaver_act"; [ "$PET_ID" = "beaver" ] && [ -f "$BEAVER_ACT" ]; then
...
ELEPH_ACT="$HOME/.mbti-pet/.eleph_act"; [ "$PET_ID" = "elephant" ] && [ -f "$ELEPH_ACT" ]; then
...
LION_ACT="$HOME/.mbti-pet/.lion_act"; [ "$PET_ID" = "lion" ] && [ -f "$LION_ACT" ]; then
...
GOLD_ACT="$HOME/.mbti-pet/.gold_act"; [ "$PET_ID" = "golden" ] && [ -f "$GOLD_ACT" ]; then
...
CAT_ACT="$HOME/.mbti-pet/.cat_act"; [ "$PET_ID" = "cat" ] && [ -f "$CAT_ACT" ]; then
...
PANDA_ACT="$HOME/.mbti-pet/.panda_act"; [ "$PET_ID" = "panda" ] && [ -f "$PANDA_ACT" ]; then
...
BLINK_FILE="$HOME/.mbti-pet/.blink"; [ -f "$BLINK_FILE" ]; then
    ...
    FRAME=-1
    echo 4 > "$HOME/.mbti-pet/.blink"  # blink lasts 5 ticks (~0.5s)
...
case "$PET_ID" in
  ...
  wolf)
    case $FRAME in
      0) L1="  _Λ/ᐠ      "; L2=" (✦  |__   "; L3="  \\\\  /   - "; L4="  |  |  ||  " ;;
      1) L1="  _Λ/ᐠ      "; L2=" (✦  |__   "; L3="  \\\\  /   ~ "; L4="  |  |  ||  " ;;
      2) L1="  _Λ/ᐠ      "; L2=" (-  |__   "; L3="  \\\\  /   - "; L4="  |  |  ||  " ;;
      3) L1="  _Λ/ᐠ      "; L2=" (✦  |__   "; L3="  \\\\  /   - "; L4="   | |  ||  " ;;
      4) L1="  _Λ/ᐠ      "; L2=" (✦  |__   "; L3="  vv  /   - "; L4="  |  |  ||  " ;;
      5) L1="  _Λ--      "; L2=" (✦  |__   "; L3="  \\\\  /   - "; L4="  |  |  ||  " ;;
      6) L1="  _Λ/ᐠ      "; L2=" (✦  |__   "; L3="  \\\\  /   - "; L4=" |    |  || " ;;
      7) L1="  _Λ/ᐠ      "; L2=" (✦_ |__   "; L3="  \\\\  /   - "; L4="  |  |  ||  " ;;
    esac ;;
  deer)
    case $FRAME in
      ...
      2) L1="  }|/  \\|{  "; L2="   (\\__/)   "; L3="   (-  o)   "; L4="    (  )    " ;;
      3) L1="  }|/  \\|{  "; L2="   (\\__/)   "; L3="   (o_ o)   "; L4="    (  )    " ;;
      4) L1="  }|/  \\|{  "; L2="   (\\__/)   "; L3="   (o  o)>  "; L4="    (  )    " ;;
      5) L1="  }|/  \\|{  "; L2="   (\\__/)   "; L3="  ( o  o )  "; L4="    (  )    " ;;
      6) L1="  }|/  \\|{  "; L2="   (\\__/)   "; L3="   (o  o) ~ "; L4="    ( )     " ;;
    esac ;;
  labrador)
    case $FRAME in
      0) L1="      __/\\  "; L2="    __/@ )  "; L3="   O     \\  "; L4="    U \\___\\- " ;;
      1) L1="      __/\\  "; L2="    __/@ )  "; L3="   O     \\  "; L4="    U \\___\\~ " ;;
      2) L1="      __/\\  "; L2="    __/- )  "; L3="   O     \\  "; L4="    U \\___\\- " ;;
      3) L1="      __/\\  "; L2="    __/@ )  "; L3="  O>     \\  "; L4="    U \\___\\- " ;;
      4) L1="      __/\\  "; L2="    __/@ )  "; L3="   O     \\  "; L4="    Ö \\___\\- " ;;
      5) L1="      __/\\  "; L2="    __/@ )  "; L3="   O     \\  "; L4="   UU \\___\\~ " ;;
      6) L1="      __/\\  "; L2="    __/@ )  "; L3="   O  ______"; L4="    U/     \\-" ;;
      7) L1="      __/\\  "; L2="    __/- )  "; L3="   O  ______"; L4="    U/     \\-" ;;
      8) L1="      __/\\  "; L2="    __/@ )  "; L3="   O  ______"; L4="    U/     \\~" ;;
    esac ;;
  dolphin)
    case $FRAME in
      0) SEA=$'\033[38;2;70;130;200m'; L1="  _.-~ʘ)    "; L2=" <(   ^ /   "; L3="  \\_.  /${SEA}~~~ "; L4=" ${SEA}   ~~~      " ;;
      1) SEA=$'\033[38;2;70;130;200m'; L1="  _.-~ʘ)    "; L2=" <(   ^ /   "; L3="  \\_.  /${SEA}~~~ "; L4=" ${SEA}  ~~~~      " ;;
      2) SEA=$'\033[38;2;70;130;200m'; L1="  _.-~-)    "; L2=" <(   ^ /   "; L3="  \\_.  /${SEA}~~~ "; L4=" ${SEA}   ~~~      " ;;
    esac ;;
  beaver)
    ...
    case $FRAME in
      ...
      7) L1="  n____n    "; L2=" (·    ·)   "; L3=" (= ${TH}T T${C}=)   "; L4="  \`----'    " ;;
      4) L1="  n____n    "; L2=" (°    °)   "; L3=" ( >${TH}TT${C}< )!! "; L4="  \`----'    " ;;
      5) L1="  n____n    "; L2=" (>    >)   "; L3=" ( >${TH}TT${C}< )   "; L4="  \`----'    " ;;
      8) L1="  n____n    "; L2=" (<    <)   "; L3=" ( >${TH}TT${C}< )   "; L4="  \`----'    " ;;
  ...
  panda)
    ...
    case $FRAME in
      ...
      3) L1="  ${PP}n${C} __ ${PP}n${C}    "; L2=" / ${PP}@${C}  ${PP}@${C} \\   "; L3=" (  ww  ${BM}====${C}"; L4="( ||  || )  " ;;
      4) L1="  ${PP}n${C} __ ${PP}n${C}    "; L2=" / ${PP}@${C}  ${PP}@${C} \\   "; L3=" (  ${BM}====${C})   "; L4="( ||  || )  " ;;
      5) L1="  ${PP}n${C} __ ${PP}n${C}    "; L2=" / ${PP}@${C}  ${PP}@${C} \\   "; L3=" (  ww${BM}==${C})   "; L4="( ||  || )  " ;;
      6) L1="  ${PP}n${C} __ ${PP}n${C}    "; L2=" / ${PP}@${C}  ${PP}@${C} \\   "; L3=" (  ww ${BM}=${C})   "; L4="( ||  || )  " ;;
      7) L1="  ${PP}n${C} __ ${PP}n${C}    "; L2=" / ${PP}@${C}  ${PP}@${C} \\   "; L3=" (  ww  )   "; L4="( ||  || )  " ;;
      8) L1="  ${PP}n${C} __ ${PP}n${C}    "; L2="  \\ ${PP}@${C}  ${PP}@${C} /  "; L3=" (  ww  )   "; L4=" ( --  -- )  " ;;
      9) L1="  ${PP}n${C} __ ${PP}n${C}    "; L2=" / ·  · \\   "; L3=" (  ww  )   "; L4="( --  -- )  " ;;
     10) L1="  ${PP}n${C} __ ${PP}n${C}    "; L2=" / >  < \\   "; L3=" (  ww  )   "; L4="( --  -- )  " ;;
    esac ;;
  cheetah)
    case $FRAME in
